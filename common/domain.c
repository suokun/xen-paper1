...
void vcpu_pause_nosync(struct vcpu *v)
{
	...
	d1 = (unsigned)(time >> 32);
	TRACE_6D(TRC_SCHED_KUN_VCPU_PAUSE_NOSYNC, 111, v->domain->domain_id, v->vcpu_id, atomic_read(&v->pause_count), d1, d2);
	//end
	...
	d2 = (unsigned)(time & 0xffffffffLL);
	d1 = (unsigned)(time >> 32);
	TRACE_6D(TRC_SCHED_KUN_VCPU_PAUSE_NOSYNC, 222, v->domain->domain_id, v->vcpu_id, atomic_read(&v->pause_count), d1, d2);
	//end
}
...
void vcpu_unpause(struct vcpu *v)
{
	...
	d2 = (unsigned)(time & 0xffffffffLL);
	d1 = (unsigned)(time >> 32);
	TRACE_6D(TRC_SCHED_VCPU_UNPAUSE, 111, v->domain->domain_id, v->vcpu_id, atomic_read(&v->pause_count), d1, d2);
	...
	d2 = (unsigned)(time & 0xffffffffLL);
	d1 = (unsigned)(time >> 32);
	TRACE_6D(TRC_SCHED_VCPU_UNPAUSE, 222, v->domain->domain_id, v->vcpu_id, atomic_read(&v->pause_count), d1, d2);
}
