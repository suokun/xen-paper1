...
#define VCPU_trap_bounce 1520 /* offsetof(struct vcpu, arch.pv_vcpu.trap_bounce) */
#define VCPU_int80_bounce 1536 /* offsetof(struct vcpu, arch.pv_vcpu.int80_bounce) */
#define VCPU_thread_flags 1048 /* offsetof(struct vcpu, arch.flags) */
#define VCPU_event_addr 1440 /* offsetof(struct vcpu, arch.pv_vcpu.event_callback_eip) */
#define VCPU_event_sel 1456 /* offsetof(struct vcpu, arch.pv_vcpu.event_callback_cs) */
#define VCPU_failsafe_addr 1448 /* offsetof(struct vcpu, arch.pv_vcpu.failsafe_callback_eip) */
#define VCPU_failsafe_sel 1460 /* offsetof(struct vcpu, arch.pv_vcpu.failsafe_callback_cs) */
#define VCPU_syscall_addr 1456 /* offsetof(struct vcpu, arch.pv_vcpu.syscall_callback_eip) */
#define VCPU_syscall32_addr 1472 /* offsetof(struct vcpu, arch.pv_vcpu.syscall32_callback_eip) */
#define VCPU_syscall32_sel 1488 /* offsetof(struct vcpu, arch.pv_vcpu.syscall32_callback_cs) */
#define VCPU_syscall32_disables_events 1492 /* offsetof(struct vcpu, arch.pv_vcpu.syscall32_disables_events) */
#define VCPU_sysenter_addr 1480 /* offsetof(struct vcpu, arch.pv_vcpu.sysenter_callback_eip) */
#define VCPU_sysenter_sel 1490 /* offsetof(struct vcpu, arch.pv_vcpu.sysenter_callback_cs) */
#define VCPU_sysenter_disables_events 1493 /* offsetof(struct vcpu, arch.pv_vcpu.sysenter_disables_events) */
#define VCPU_trap_ctxt 1224 /* offsetof(struct vcpu, arch.pv_vcpu.trap_ctxt) */
...
#define VCPU_svm_vmcb_pa 1544 /* offsetof(struct vcpu, arch.hvm_vcpu.u.svm.vmcb_pa) */
#define VCPU_svm_vmcb 1536 /* offsetof(struct vcpu, arch.hvm_vcpu.u.svm.vmcb) */
#define VCPU_svm_vmcb_in_sync 1564 /* offsetof(struct vcpu, arch.hvm_vcpu.u.svm.vmcb_in_sync) */

#define VCPU_vmx_launched 1580 /* offsetof(struct vcpu, arch.hvm_vcpu.u.vmx.launched) */
#define VCPU_vmx_realmode 1801 /* offsetof(struct vcpu, arch.hvm_vcpu.u.vmx.vmx_realmode) */
#define VCPU_vmx_emulate 1802 /* offsetof(struct vcpu, arch.hvm_vcpu.u.vmx.vmx_emulate) */
#define VCPU_vm86_seg_mask 1804 /* offsetof(struct vcpu, arch.hvm_vcpu.u.vmx.vm86_segment_mask) */
#define VCPU_hvm_guest_cr2 1104 /* offsetof(struct vcpu, arch.hvm_vcpu.guest_cr[2]) */

#define VCPU_nhvm_guestmode 2024 /* offsetof(struct vcpu, arch.hvm_vcpu.nvcpu.nv_guestmode) */
#define VCPU_nhvm_p2m 2256 /* offsetof(struct vcpu, arch.hvm_vcpu.nvcpu.nv_p2m) */
#define VCPU_nsvm_hap_enabled 2212 /* offsetof(struct vcpu, arch.hvm_vcpu.nvcpu.u.nsvm.ns_hap_enabled) */
