...
/***********************[begin]*************************************/
    ...
    uint64_t	       idle_running_time_this_timeslice;
    uint64_t	       t_start, t_end;
 //   int		       state_AB;    //0:state A, 1:state B
    uint64_t	       prev_start_time, prev_end_time, this_start_time, this_end_time;
    int		       is_do_sleep;
    atomic_t           do_sleep_flag;
/***********************[end]***************************************/
