...
void mwait_idle_with_hints(unsigned int eax, unsigned int ecx)
{
    ...
    uint64_t time = NOW();
    uint32_t d2 = (unsigned)(time & 0xffffffffLL);
    uint32_t d1 = (unsigned)(time >> 32);
    uint32_t t1, t2;
    TRACE_4D(TRC_SCHED_KUN_22, d1, d2, 55555, cpu);
	...
	TRACE_4D(TRC_SCHED_KUN_22, d1, d2, 66666, cpu);
        cpumask_set_cpu(cpu, &cpuidle_mwait_flags);

	time = NOW();
        d2 = (unsigned)(time & 0xffffffffLL);
        d1 = (unsigned)(time >> 32);
	t2 = (unsigned)(expires & 0xffffffffLL);
	t1 = (unsigned)(expires >> 32);
 	TRACE_6D(TRC_SCHED_KUN_21, d1, d2, 1, cpu, t1, t2);
	...
	t2 = (unsigned)(expires & 0xffffffffLL);
	t1 = (unsigned)(expires >> 32);
 	TRACE_6D(TRC_SCHED_KUN_21, d1, d2, 2, cpu, t1, t2);
	...
	t2 = (unsigned)(expires & 0xffffffffLL);
	t1 = (unsigned)(expires >> 32);
 	TRACE_6D(TRC_SCHED_KUN_21, d1, d2, 3, cpu, t1, t2);
    }
	...
	TRACE_4D(TRC_SCHED_KUN_22, d1, d2, 77777, cpu);
