...
/*    time = NOW();
    ...
    d1 = (unsigned)(time >> 32);
    TRACE_6D(TRC_SCHED_KUN_18, prev->domain->domain_id, prev->vcpu_id, next->domain->domain_id, next->vcpu_id, d1, d2);
*/
...
void vcpu_mark_events_pending(struct vcpu *v)
{
    ...
    TRACE_3D(TRC_SCHED_KUN_13, v->domain->domain_id, v->vcpu_id, 
